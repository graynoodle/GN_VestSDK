...
/** Category of additions for `<GrayN_FMDatabase>` class.
...
@interface GrayN_FMDatabase (GrayN_FMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `GrayN_FMResultSet` of schema; `nil` on error.
